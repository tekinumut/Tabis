...
public class HomepageTab2Adapter extends RecyclerView.Adapter<HomepageTab2Adapter.HomepageTab2ViewHolder> {
	 ...
	 phpValues.get1Parameter(mContext, "Select NOW()", dateStop -> {
		...
		try {
		  ...
		  if (diffDays == 0) //Geçen zaman 0 ile 24 saat arasında ise
		  {
			 ...
			 holder._recyclerRemainingDate2.setText(mContext.getString(R.string.yenieklendi));
		  } else if (diffDays >= 1 && diffWeeks < 1) //Geçen zaman 1 gün ile 7 gün arasında ise
		  {
			 holder._recyclerRemainingDate2.setTextColor(mContext.getResources().getColor(R.color.DuzYesil));
			 holder._recyclerRemainingDate2.setText(diffDays + " gün " + period.getHours() + " saat");
			 if (period.getHours() == 0)
				holder._recyclerRemainingDate2.setText(diffDays + " gün");
		  } else if (diffWeeks >= 1 && diffMonths < 1) //Geçen zaman 1 hafta ile 1 ay arasında ise
		  {
			 ...
			 holder._recyclerRemainingDate2.setText(diffWeeks + " hafta " + periodWeeks.getDays() + " gün");
			 if (periodWeeks.getDays() == 0)
				holder._recyclerRemainingDate2.setText(diffWeeks + " hafta");
		  } else if (diffMonths >= 1 && diffYears < 1) //Geçen zaman 1 aydan fazla ve 1 yıldan az ise
		  {
			 ...
			 holder._recyclerRemainingDate2.setText(diffMonths + " ay " + period.getDays() + " gün");
			 
			 if (period.getDays() == 0)
				holder._recyclerRemainingDate2.setText(diffMonths + " ay");
			 
		  } else if (diffYears >= 1)   //Geçen zaman 1 yıldan fazla ise
		  {
			 holder._recyclerRemainingDate2.setTextColor(mContext.getResources().getColor(R.color.RedKırmızı));
			 holder._recyclerRemainingDate2.setText(diffYears + " yıl " + period.getMonths() + " ay " + period.getDays() + " gün");
			 
			 if (period.getMonths() == 0)
				holder._recyclerRemainingDate2.setText(diffYears + " yıl " + period.getDays() + " gün");
			 else if (period.getDays() == 0)
				holder._recyclerRemainingDate2.setText(diffYears + " yıl " + period.getMonths() + " ay");
			 else if (period.getMonths() == 0 && period.getDays() == 0)
				holder._recyclerRemainingDate2.setText(diffYears + " yıl");
  ...
  public class HomepageTab2ViewHolder extends RecyclerView.ViewHolder {
	 ...
	 public HomepageTab2ViewHolder(final View itemView, final Context context) {
		...
		_recyclerImageViewHide.setOnClickListener(v -> {
		  ...
		  DialogInterface.OnClickListener dialogClickListener = (dialog, which) -> {
			 switch (which) {
				case DialogInterface.BUTTON_POSITIVE:
				  ...
				  phpValues.sentItem(mContext, sqlcode, null, "deleterecord", response -> {
