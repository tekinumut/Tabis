...
public class ChangeState extends DialogFragment {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
	 ...
	 editorKarisikDegerler = preferencesKarisikDegerler.edit();
	 editorKarisikDegerler.apply();
	 ...
	 getgallery.setOnClickListener(v -> requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST));
