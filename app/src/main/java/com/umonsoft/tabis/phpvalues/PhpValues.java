...
public class PhpValues {
  ...
  public void get1Parameter(final Context mContext, final String sqlcode, final VolleyGet1Parameter callback) {
	 ...
	 StringRequest stringRequest = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, "http://" + Constants.BASE_URL + "/get1parameter.php", response -> {
  ...
  public void get2Parameter(final Context mContext, final String sqlcode, final VolleyGet2Parameter callback) {
	 ...
	 StringRequest stringRequest = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, "http://" + Constants.BASE_URL + "/get2parameter.php", response -> {
  ...
  public void sentItem(final Context mContext, final String sqlcode, final String parameter1, final String deger, final VolleyGet1Parameter callback) {
	 ...
	 StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://" + Constants.BASE_URL + "/sentitem.php", response -> {
	 ...
	 }, error -> Toast.makeText(mContext, mContext.getString(R.string.birhatameydanageldi), Toast.LENGTH_LONG).show()) {
		@Override
		protected Map<String, String> getParams() {
		  Map<String, String> params = new HashMap<>();
  ...
  public void setLoginDetails(final Context mContext, final int user_id, final SharedPreferences.Editor editorlogin) {
	 StringRequest stringRequest = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, "http://" + Constants.BASE_URL + "/logindetails.php", response -> {
  ...
  public void loadRecordValues(final Context mContext, final RecyclerView recyclerView, final int tabcount, final String sqlcode, final VolleyGet1Parameter callback) {
	 ...
	 StringRequest stringRequest = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, "http://" + Constants.BASE_URL + "/getrecords.php", response -> {
	 ...
	 }, error -> Toast.makeText(mContext, mContext.getString(R.string.kayityuklenemedi), Toast.LENGTH_SHORT).show()) {
		@Override
		protected Map<String, String> getParams() {
  ...
  public void sendRecords(final Context mContext, final String imageData, final String sqlcode, final String targetnamesql, final VolleyGet1ParameterWithError callback) {
	 ...
	 StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://" + Constants.BASE_URL + "/sentrecords.php", response -> {
